        ...
        <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron primary-background text-white banner-background">
                <div class="container">
                    ...
                    <p>Welcome to TechBlog,world of technology
                    ...
                    <p>Most programming languages consist of instructions for computers. There are programmable machines that use a set of specific instructions, rather than general programming languages. Since the early 1800s, programs have been used to direct the behavior of machines such as Jacquard looms, music boxes and player pianos.[1]</p>

                    <button class="btn btn-outline-light btn-lg"><span class="fa fa-user-plus"> </span> Start! its First</button>
